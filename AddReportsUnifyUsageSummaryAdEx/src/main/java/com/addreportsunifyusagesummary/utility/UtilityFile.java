package com.addreportsunifyusagesummary.utility;
...
public class UtilityFile
{
	...
	public static void screenShot(WebDriver driver) 
	{
		...
		try {
			FileUtils.copyFile(src, new File("C:\\Users\\funak\\AutomationTester\\AddReportsUnifyUsageSummary\\ScreenShots\\"+d+".png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
